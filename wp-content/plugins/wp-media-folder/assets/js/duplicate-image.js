...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        if (wpmfFoldersModule.page_type !== 'upload-list') {
            ...
            var form_uplicate = '<button type="button" class="button wpmf_btn_duplicate">' + wpmf.l18n.duplicate_text + '<span class="wpmf_spinner_duplicate"></span></button><p class="wpmf_message_duplicate"></p>';
